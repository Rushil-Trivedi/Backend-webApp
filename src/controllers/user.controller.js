...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  const user = User.findByIdAndUpdate(
    req.user?._id,
    {
      // set is an operator of "MongoDB."
      $set: {
        // here we can also write fullname: fullname, but in ES-6 model we can use by just writing "fullname".
        fullName,
        email: email,
      },
    },
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  // ***TODO: Delete Old Image. make utility function.
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  // here we are writing the pipelines. pipelines is written in {},{},{} curly braces.
